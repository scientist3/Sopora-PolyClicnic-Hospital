...
class Notice extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_nurse/noticeboard/notice_model'
		));
	...
	{  
		...
		$data['content'] = $this->load->view('dashboard_nurse/noticeboard/view',$data,true);
	...
	{   
		...
		$data['content'] = $this->load->view('dashboard_nurse/noticeboard/details',$data,true);
		$this->load->view('dashboard_nurse/main_wrapper',$data);
	} 
