                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open('dashboard_receptionist/appointment/appointment/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                <label for="doctor_cons_fee" class="col-xs-3 col-form-label"><?php echo display('doctor_cons_fee') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="doctor_cons_fee" autocomplete="off" type="text" class="form-control" id="doctor_cons_fee" placeholder="<?php echo display('doctor_cons_fee') ?>" value="0" hidden>
                                    <span></span>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#doctor_id").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_receptionist/appointment/appointment/doctor_cons_fee/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
                '<?= $this->security->get_csrf_token_name(); ?>' : '<?= $this->security->get_csrf_hash(); ?>',
        ...
        $.ajax({
            ...
            {
                if (data.status == true) {
                    outputfee.html(data.message).addClass('text-success').removeClass('text-danger');
                }
            },
            error : function()
            {
