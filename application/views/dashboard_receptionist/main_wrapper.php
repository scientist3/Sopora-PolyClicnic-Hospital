            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == 'account') ? "active" : null) ?>">
                            <a href="<?php echo base_url('dashboard_receptionist/account/account') ?>"><i class="fa fa-money"></i> <?php echo display('account') ?></a>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "appointment" || $this->uri->segment(2) == "report") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php /* <li><a href="<?php echo base_url("dashboard_receptionist/appointment/report/assign_by_me") ?>"> <?php echo display('assign_by_me') ?> </a></li> */?>
                            </ul>
                        </li>  
