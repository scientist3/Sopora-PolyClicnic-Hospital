                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('doctor/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                <label for="consfee" class="col-xs-3 col-form-label"><?php echo display('consultation_fee') ?></label>
                                <div class="col-xs-9">
                                    <input name="consfee" class="form-control" type="text" placeholder="<?php echo display('consultation_fee') ?>" id="consfee" value="<?php echo $doctor->consfee ?>" >
                                </div>
                            </div>
