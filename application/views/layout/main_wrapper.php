                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "doctor") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php /* <li><a href="<?php echo base_url("doctor/consfee") ?>"><?php echo display('consultation_fee') ?></a></li> */?>
                        ...
                        <!--############################## PRESCRIPTION ##############################-->
                        <?php /* <li class="treeview <?php echo (($this->uri->segment(1) == "prescription") ? "active" : null) ?>">
                            <a href="#">
                        ...
                        <!--############################## BED MANAGEMENT ##############################-->
                        <?php /*<li class="treeview <?php echo (($this->uri->segment(1) == "bed_manager") ? "active" : null) ?>">
                            <a href="#">
                        ...
                        <!--############################## CASE MANAGER ##############################-->
                        <?php /* <li class="treeview <?php echo (($this->uri->segment(1) == "case_manager") ? "active" : null) ?>">
                            <a href="#">
                        ...
                        <!--############################## HOSPITAL ACTIVITIES ##############################-->
                        <?php /* <li class="treeview <?php echo (($this->uri->segment(1) == "hospital_activities") ? "active" : null) ?>">
                            <a href="#">
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "messages") ? "active" : null) ?>">
                         ...
                         <!--############################## MAIL ##############################-->
                        <?php /* <li class="treeview <?php echo (($this->uri->segment(1) == "mail") ? "active" : null) ?>">
                            <a href="#">
