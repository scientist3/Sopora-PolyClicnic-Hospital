            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "hospital_activities") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-hospital-o"></i><span><?php echo display('stock') ?> </span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/purchase') ?>"><?php echo display('addPurchase') ?></a></li>
                                
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/purchase_list') ?>"><?php echo display('purchase_list') ?></a></li>
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/sale') ?>"><?php echo display('sale') ?></a></li>
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/listSale') ?>"><?php echo display('list_sale') ?></a></li>
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/addSupplier') ?>"><?php echo display('add_supplier') ?></a></li>
                                <li><a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/stock/listSupplier') ?>"><?php echo display('list_supplier') ?></a></li>
