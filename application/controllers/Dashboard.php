...
class Dashboard extends CI_Controller {
    ...
    public function index()
    {
        ...
        // This Function Gets Called By Default As Supposed 
        ...
        // Setting Rules For Validation For Future Use in Comming Code    
        ...
        // Using Setting_Model And  calling Its read() Function to get the setting from Database
        $setting = $this->setting_model->read();

        // Fetching Data From Setting If Its Exist
        ...
        if ($this->form_validation->run() === true) {
            // When User Clecks Submit Button It Runs After Validation is done
            ...
            //////// HERE IF EVERYTHING WORKS FINE THEN This View Gets Loaded That Is {"layout/login_wrapper"} ##############
