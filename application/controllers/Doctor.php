...
class Doctor extends CI_Controller {
	...
	{
		//echo "Cont/Doctors.php/create";exit();
		...
		$this->form_validation->set_rules('consfee', display('consultaion_fee') ,'max_length[10]');
		...
		if ($this->input->post('user_id',true) == null) {
			$data['doctor'] = (object)$postData = [
				...
				'consfee'   	   => $this->input->post('consfee',true),
	...
	public function consfee()
	{
		$data['title'] = display('consultaion_fee');
		//$data['doctors'] = $this->doctor_model->read();
		$data['content'] = $this->load->view('doctor',$data,true);
		$this->load->view('layout/main_wrapper',$data);
